...
```{r}
gdp_dija <- read_csv("gdp_djia.csv")
```
...
The scatterplot clearly shows a positive correlation between a higher GDP and higher DJIA score. With a  coefficient of about .9, it is a very strong correlation. Interpreting this, this means that higher stock values will mean that the market value of all goods will be higher, and vice versa. 
