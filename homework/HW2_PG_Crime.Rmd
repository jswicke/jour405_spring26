...
```{r}
pg_crime <- read_csv("pg_crime_totals_2024.csv")
```
...
Generally, the crimes can either be categorized as petty/misdemeanors (theft and accidents), or violent crimes/felonies (Assaut, robbery, b&e, sex offenses, etc.). While not "more important," I do think that violent crimes are more eye-catching, though I think crimes like theft and accidents would be more relevant to the public. Any crime that has multiple sub-categories (Assault, assault with a weapon, and assault shooting, for example), mkes summarizing. bit more difficult, as you have to factor in multiple datasets.
...
The three highest averages are accidents, stolen automobiles and theft from automobiles. The three lowest are Homicide, Breaking and Entering (other) and Sex offenses. I think most of the categories make sense, though I do wonder why there's more stolen vehicles than thefts from a vehicle, as the latter seems like it would be more prevalent. 
...
A few categories had some bumps in activity. Vehicle robberies, stolen and recovered auto thefts, and sex offenses are just some examples of the spikes in activity in crime during the summer. At the same time, crime was significantly down more than average in many categories. Breaking and entering was down throughout the entire summer, and some categories of robberies went down as the summer progressed. I don't think it's accurate to say crime goes up in the summer --- it fluctuates just like it would any month. 
...
Store robberies in Prince George's County skyrocketed in August after a summer of below-average rates, the Prince George's County Police Department reported in its latest crime report. 

The police department reported 29 commercial robberies, the act of taking property from a business through force or intimidation,   throughout the month, up 43% from the average amount per month. Comparitively, rates in July eked just below the monthly average of 20 commercial robberies. In June, the rates were even lower, down around 18% from the average. 
